...
namespace MVCCore.Repositories.StockTasks
{
    ...
    public interface IWarehouseInvoiceAPIRepository : IGenericAPIRepository
    {
        ...
        IEnumerable<PendingGoodsReceiptDetail> GetPendingGoodsReceiptDetails(int goodsReceiptID, string aspUserID, int locationID, int warehouseID, int commodityTypeID, DateTime fromDate, DateTime toDate, int warehouseInvoiceID, string goodsReceiptDetailIDs);
