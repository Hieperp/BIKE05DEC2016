...
namespace MVCModel.Models
{
    ...
    public partial class TotalBikePortalsEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> PartsInvoiceApproved(Nullable<int> entityID)
        {
            var entityIDParameter = entityID.HasValue ?
                new ObjectParameter("EntityID", entityID) :
                new ObjectParameter("EntityID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("PartsInvoiceApproved", entityIDParameter);
        }
    
        public virtual ObjectResult<string> ServicesInvoiceApproved(Nullable<int> entityID)
        {
            var entityIDParameter = entityID.HasValue ?
                new ObjectParameter("EntityID", entityID) :
                new ObjectParameter("EntityID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("ServicesInvoiceApproved", entityIDParameter);
        }
    
        public virtual int PartsInvoiceToggleApproved(Nullable<int> entityID, Nullable<bool> approved)
        {
            var entityIDParameter = entityID.HasValue ?
                new ObjectParameter("EntityID", entityID) :
                new ObjectParameter("EntityID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PartsInvoiceToggleApproved", entityIDParameter, approvedParameter);
        }
    
        public virtual int ServicesInvoiceToggleApproved(Nullable<int> entityID, Nullable<bool> approved)
        {
            var entityIDParameter = entityID.HasValue ?
                new ObjectParameter("EntityID", entityID) :
                new ObjectParameter("EntityID", typeof(int));
        ...
        public virtual ObjectResult<WarehouseInvoiceIndex> GetWarehouseInvoiceIndexes(string aspUserID, Nullable<System.DateTime> fromDate, Nullable<System.DateTime> toDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<WarehouseInvoiceIndex>("GetWarehouseInvoiceIndexes", aspUserIDParameter, fromDateParameter, toDateParameter);
        }
    
        public virtual ObjectResult<WarehouseInvoiceViewDetail> GetWarehouseInvoiceViewDetails(Nullable<int> warehouseInvoiceID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<WarehouseInvoiceViewDetail>("GetWarehouseInvoiceViewDetails", warehouseInvoiceIDParameter);
        }
    
        public virtual ObjectResult<string> WarehouseInvoicePostSaveValidate(Nullable<int> entityID)
        {
            var entityIDParameter = entityID.HasValue ?
                new ObjectParameter("EntityID", entityID) :
                new ObjectParameter("EntityID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("WarehouseInvoicePostSaveValidate", entityIDParameter);
        }
    
        public virtual int WarehouseInvoiceSaveRelative(Nullable<int> entityID, Nullable<int> saveRelativeOption)
        {
            var entityIDParameter = entityID.HasValue ?
                new ObjectParameter("EntityID", entityID) :
                new ObjectParameter("EntityID", typeof(int));
        ...
        public virtual int UpdateAccountInvoiceApi(Nullable<int> accountInvoiceID, Nullable<int> apiSerialID, string apiSerialString, string responedMessage)
        {
            ...
            var apiSerialIDParameter = apiSerialID.HasValue ?
                ...
                new ObjectParameter("ApiSerialID", typeof(int));
    
            var apiSerialStringParameter = apiSerialString != null ?
