...
namespace MVCData.Helpers.SqlProgrammability.SalesTasks
{
    public class ServicesInvoice
    {
        ...
        private void SalesInvoicePrint()
        {
            ...
            queryString = queryString + "                       ServiceContracts.EntryDate AS ServiceContractEntryDate, Vehicles.Name AS VehicleName, ServiceContracts.ChassisCode, ServiceContracts.EngineCode, ServiceContracts.LicensePlate, ServiceContracts.ColorCode, ServiceContracts.AgentName, ServiceContracts.EndingMeters, ServiceContracts.EndingDate, SalesInvoices.CurrentMeters, SalesInvoices.IsMajorRepair, SalesInvoices.FailingPartReturned, SalesInvoices.NextMaintenance, SalesInvoices.NextMaintenanceDate, SalesInvoices.NextMaintenanceMeters, SalesInvoices.VehicleCleaning, " + "\r\n";
            queryString = queryString + "                       SalesInvoices.CheckedBrakeFluid, SalesInvoices.CheckedFrontBrake, SalesInvoices.CheckedRearBrake, SalesInvoices.CheckedLights, SalesInvoices.CheckedSwitch, SalesInvoices.CheckedHorn, SalesInvoices.CheckedFrontWheel, SalesInvoices.CheckedRearWheel, SalesInvoices.CheckedEngineOil, SalesInvoices.CheckedCoolant, SalesInvoices.CheckedChain, SalesInvoices.CheckedSpeedoMeter,  " + "\r\n";
            queryString = queryString + "                       SalesInvoices.CheckedBrakeCord, SalesInvoices.CheckedGearOil, SalesInvoices.CheckedCuroa, SalesInvoices.CheckedBattery, SalesInvoices.CheckedAirFilter, SalesInvoices.CheckedGearChain, SalesInvoices.CheckedClutch, SalesInvoices.CheckedCarbonBrushes, SalesInvoices.CheckedThrottle, SalesInvoices.CheckedSparkPlug, " + "\r\n";
            ...
            this.totalBikePortalsEntities.CreateStoredProcedure("SalesInvoicePrint2017", queryString);
