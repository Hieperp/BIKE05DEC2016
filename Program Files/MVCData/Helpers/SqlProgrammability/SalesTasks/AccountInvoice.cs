...
namespace MVCData.Helpers.SqlProgrammability.SalesTasks
{
    class AccountInvoice
    {
        ...
        private void AccountInvoiceSheet()
        {
            ...
            queryString = queryString + "                       Locations.OfficialName AS LocationOfficialName, Locations.Address AS LocationAddress, Locations.Telephone AS LocationTelephone, Locations.Facsimile AS LocationFacsimile " + "\r\n";
